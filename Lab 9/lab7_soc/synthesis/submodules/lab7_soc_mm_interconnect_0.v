...
module lab7_soc_mm_interconnect_0 (
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> to_sw_sig_s1_agent:cp_valid
	wire  [106:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> to_sw_sig_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // to_sw_sig_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [9:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> to_sw_sig_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> to_sw_sig_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> to_sw_sig_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_008_src_valid;                                                              // cmd_mux_008:src_valid -> to_hw_port_s1_agent:cp_valid
	wire  [106:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> to_hw_port_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                              // to_hw_port_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire    [9:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> to_hw_port_s1_agent:cp_channel
	wire          cmd_mux_008_src_startofpacket;                                                      // cmd_mux_008:src_startofpacket -> to_hw_port_s1_agent:cp_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                        // cmd_mux_008:src_endofpacket -> to_hw_port_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_009_src_valid;                                                              // cmd_mux_009:src_valid -> to_hw_sig_s1_agent:cp_valid
	wire  [106:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> to_hw_sig_s1_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                              // to_hw_sig_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire    [9:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> to_hw_sig_s1_agent:cp_channel
	wire          cmd_mux_009_src_startofpacket;                                                      // cmd_mux_009:src_startofpacket -> to_hw_sig_s1_agent:cp_startofpacket
	wire          cmd_mux_009_src_endofpacket;                                                        // cmd_mux_009:src_endofpacket -> to_hw_sig_s1_agent:cp_endofpacket
	...
	wire          to_sw_sig_s1_agent_rp_valid;                                                        // to_sw_sig_s1_agent:rp_valid -> router_008:sink_valid
	wire  [106:0] to_sw_sig_s1_agent_rp_data;                                                         // to_sw_sig_s1_agent:rp_data -> router_008:sink_data
	wire          to_sw_sig_s1_agent_rp_ready;                                                        // router_008:sink_ready -> to_sw_sig_s1_agent:rp_ready
	wire          to_sw_sig_s1_agent_rp_startofpacket;                                                // to_sw_sig_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          to_sw_sig_s1_agent_rp_endofpacket;                                                  // to_sw_sig_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          to_hw_port_s1_agent_rp_valid;                                                       // to_hw_port_s1_agent:rp_valid -> router_010:sink_valid
	wire  [106:0] to_hw_port_s1_agent_rp_data;                                                        // to_hw_port_s1_agent:rp_data -> router_010:sink_data
	wire          to_hw_port_s1_agent_rp_ready;                                                       // router_010:sink_ready -> to_hw_port_s1_agent:rp_ready
	wire          to_hw_port_s1_agent_rp_startofpacket;                                               // to_hw_port_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          to_hw_port_s1_agent_rp_endofpacket;                                                 // to_hw_port_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire          to_hw_sig_s1_agent_rp_valid;                                                        // to_hw_sig_s1_agent:rp_valid -> router_011:sink_valid
	wire  [106:0] to_hw_sig_s1_agent_rp_data;                                                         // to_hw_sig_s1_agent:rp_data -> router_011:sink_data
	wire          to_hw_sig_s1_agent_rp_ready;                                                        // router_011:sink_ready -> to_hw_sig_s1_agent:rp_ready
	wire          to_hw_sig_s1_agent_rp_startofpacket;                                                // to_hw_sig_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire          to_hw_sig_s1_agent_rp_endofpacket;                                                  // to_hw_sig_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire          to_sw_sig_s1_agent_rdata_fifo_src_valid;                                            // to_sw_sig_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] to_sw_sig_s1_agent_rdata_fifo_src_data;                                             // to_sw_sig_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          to_sw_sig_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_006:in_0_ready -> to_sw_sig_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> to_sw_sig_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> to_sw_sig_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // to_sw_sig_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> to_sw_sig_s1_agent:rdata_fifo_sink_error
	...
	wire          to_hw_port_s1_agent_rdata_fifo_src_valid;                                           // to_hw_port_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] to_hw_port_s1_agent_rdata_fifo_src_data;                                            // to_hw_port_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire          to_hw_port_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_008:in_0_ready -> to_hw_port_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_008_out_0_valid;                                                  // avalon_st_adapter_008:out_0_valid -> to_hw_port_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                                   // avalon_st_adapter_008:out_0_data -> to_hw_port_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                                  // to_hw_port_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                                  // avalon_st_adapter_008:out_0_error -> to_hw_port_s1_agent:rdata_fifo_sink_error
	wire          to_hw_sig_s1_agent_rdata_fifo_src_valid;                                            // to_hw_sig_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire   [33:0] to_hw_sig_s1_agent_rdata_fifo_src_data;                                             // to_hw_sig_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire          to_hw_sig_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_009:in_0_ready -> to_hw_sig_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_009_out_0_valid;                                                  // avalon_st_adapter_009:out_0_valid -> to_hw_sig_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_009_out_0_data;                                                   // avalon_st_adapter_009:out_0_data -> to_hw_sig_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_009_out_0_ready;                                                  // to_hw_sig_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire    [0:0] avalon_st_adapter_009_out_0_error;                                                  // avalon_st_adapter_009:out_0_error -> to_hw_sig_s1_agent:rdata_fifo_sink_error
