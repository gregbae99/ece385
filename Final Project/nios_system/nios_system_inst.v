	nios_system u0 (
		...
		.game_state_export      (<connected-to-game_state_export>),      //      game_state.export
		.keycode_export         (<connected-to-keycode_export>),         //         keycode.export
		.next_block1_export     (<connected-to-next_block1_export>),     //     next_block1.export
		.next_block2_export     (<connected-to-next_block2_export>),     //     next_block2.export
