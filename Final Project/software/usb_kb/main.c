...
#define next_block1			(volatile int*) 0x0080
#define game_state			(volatile int*) 0x0050
#define next_block2			(volatile int*) 0x0040
...
int main(void)
{
	...
	while(1)
	{
		...
		{
			*next_block1 = (rand()%7)+1;
			*next_block2 = (rand()%7)+1;
			usleep(5);
		}
